          ...
          <div className="relative w-full h-[60vh] md:h-[80vh] overflow-hidden">
            <div className="grid h-full grid-cols-3 grid-rows-2 gap-1.5 md:gap-2">
              {VIDEO_PLACEHOLDERS.map((n, i) => (
                ...
                >
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-b from-canvas/30 to-ink/[0.08]"
                    whileHover={{
                      background:
                        i % 2 === 0
                          ? 'linear-gradient(to bottom, rgba(245,245,240,0.2), rgba(13,13,13,0.18))'
                          : 'linear-gradient(to bottom, rgba(245,245,240,0.15), rgba(232,255,0,0.18))',
                    }}
                  ...
                  >
                    <span className="flex h-9 w-9 items-center justify-center rounded-full border border-ink/25 bg-canvas/80 text-ink/75">
